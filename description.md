...
The OSE aggregates knowledge on how to transition experimental research products to robust, high-quality research software into a centralized resource; that resource, in turn, is then used to transform other research products.
